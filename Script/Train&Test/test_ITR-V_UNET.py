...
def main():
    ...
    test_img_folder = "/mnt/Dataset/Test_Single_Patch/ITR_V/Images"
    test_mask_folder = "/mnt/Dataset/Test_Single_Patch/ITR_V/Masks"
    test_res_folder = "/mnt/Dataset/Test_Single_Patch/ITR_V/Results_SYN"
    ...
    '''
    t_test = A.Compose([
                        A.Resize(1200, 1920, p=1.0),
                        A.CenterCrop(1200, 1200, p=1.0),
                        A.Resize(608, 608, p=1.0)
                      ])
    '''
